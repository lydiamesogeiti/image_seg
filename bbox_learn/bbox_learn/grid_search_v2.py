"""
Grid Search V2 - Comprehensive GuidedBox Model Search
======================================================
Search dimensions:
...
Usage:
    python grid_search_v2.py --config guidedbox_config.yaml --device cuda
    python grid_search_v2.py --config guidedbox_config.yaml --device cuda --output_dir guided_box_ijmond/grid_search_v2
"""
...
def setup_logging(log_dir):
    ...
    log_file = os.path.join(log_dir, f"grid_search_v2_{timestamp}.log")
...
def main():
    parser = argparse.ArgumentParser(
        description='GuidedBox Grid Search V2')
    parser.add_argument('--config', type=str,
                        default='guidedbox_config.yaml')
    parser.add_argument('--device', type=str, default=None)
    parser.add_argument('--output_dir', type=str,
                        default='guided_box_ijmond/grid_search_v2')
    ...
    logging.info("=" * 70)
    logging.info("Grid Search V2: Comprehensive Search")
    logging.info("=" * 70)
    ...
    # ---- Summary ----
    logging.info(f"\n{'='*70}")
    logging.info(f"GRID SEARCH V2 COMPLETE: {len(grid_results)} models "
